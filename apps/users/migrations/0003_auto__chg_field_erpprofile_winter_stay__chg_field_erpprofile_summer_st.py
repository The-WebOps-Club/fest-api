...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_erpprofile', 'winter_stay', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ERPProfile.summer_stay'
        db.alter_column(u'users_erpprofile', 'summer_stay', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
