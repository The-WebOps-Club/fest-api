...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subdept.is_active'
        db.add_column(u'users_subdept', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Page.is_active'
        db.add_column(u'users_page', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        # Adding field 'ERPProfile.is_active'
        db.add_column(u'users_erpprofile', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Dept.is_active'
        db.add_column(u'users_dept', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subdept.is_active'
        db.delete_column(u'users_subdept', 'is_active')

        # Deleting field 'Page.is_active'
        db.delete_column(u'users_page', 'is_active')

        # Deleting field 'UserProfile.is_active'
        db.delete_column(u'users_userprofile', 'is_active')

        # Deleting field 'ERPProfile.is_active'
        db.delete_column(u'users_erpprofile', 'is_active')

        # Deleting field 'Dept.is_active'
        db.delete_column(u'users_dept', 'is_active')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
