...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ERPProfile.winter_stay'
        db.alter_column(u'users_erpprofile', 'winter_stay', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ERPProfile.summer_stay'
        db.alter_column(u'users_erpprofile', 'summer_stay', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'ERPProfile.winter_stay'
        db.alter_column(u'users_erpprofile', 'winter_stay', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'ERPProfile.summer_stay'
        db.alter_column(u'users_erpprofile', 'summer_stay', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        u'users.erpprofile': {
            ...
            'summer_stay': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'winter_stay': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        u'users.subdept': {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 13, 0, 0)'}),
