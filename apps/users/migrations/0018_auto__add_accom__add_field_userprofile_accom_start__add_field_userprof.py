...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Accom'
        db.create_table(u'users_accom', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='accom', unique=True, to=orm['auth.User'])),
            ('start_date', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('start_time', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('end_date', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('end_time', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'users', ['Accom'])
    ...
    def backwards(self, orm):
        # Deleting model 'Accom'
        db.delete_table(u'users_accom')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'accom_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 25, 0, 0)'}),
            'accom_gender': ('django.db.models.fields.CharField', [], {'default': "'F'", 'max_length': '1'}),
            'accom_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 25, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 25, 0, 0)'}),
