...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Page'
        db.create_table(u'users_page', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wall', self.gf('django.db.models.fields.related.OneToOneField')(related_name='page', unique=True, to=orm['walls.Wall'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True)),
            ('time_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0), auto_now=True, blank=True)),
            ('cache_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['Page'])

        # Adding field 'Subdept.time_updated'
        db.add_column(u'users_subdept', 'time_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Subdept.cache_updated'
        db.add_column(u'users_subdept', 'cache_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field page_relations on 'ERPProfile'
        m2m_table_name = db.shorten_name(u'users_erpprofile_page_relations')
        ...
        db.create_unique(m2m_table_name, ['erpprofile_id', 'page_id'])

        # Adding field 'Dept.time_updated'
        db.add_column(u'users_dept', 'time_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Dept.cache_updated'
        db.add_column(u'users_dept', 'cache_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0), auto_now=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'Page'
        db.delete_table(u'users_page')

        # Deleting field 'Subdept.time_updated'
        db.delete_column(u'users_subdept', 'time_updated')

        # Deleting field 'Subdept.cache_updated'
        db.delete_column(u'users_subdept', 'cache_updated')

        # Removing M2M table for field page_relations on 'ERPProfile'
        db.delete_table(db.shorten_name(u'users_erpprofile_page_relations'))

        # Deleting field 'Dept.time_updated'
        db.delete_column(u'users_dept', 'time_updated')

        # Deleting field 'Dept.cache_updated'
        db.delete_column(u'users_dept', 'cache_updated')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)'}),
