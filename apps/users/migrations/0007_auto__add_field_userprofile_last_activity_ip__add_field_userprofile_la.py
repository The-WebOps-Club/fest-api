...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_activity_ip'
        db.add_column(u'users_userprofile', 'last_activity_ip',
                      self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15),
                      keep_default=False)

        # Adding field 'UserProfile.last_activity_date'
        db.add_column(u'users_userprofile', 'last_activity_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_activity_ip'
        db.delete_column(u'users_userprofile', 'last_activity_ip')

        # Deleting field 'UserProfile.last_activity_date'
        db.delete_column(u'users_userprofile', 'last_activity_date')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 11, 0, 0)'}),
