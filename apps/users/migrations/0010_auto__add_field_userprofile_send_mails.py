...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.send_mails'
        db.add_column(u'users_userprofile', 'send_mails',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.send_mails'
        db.delete_column(u'users_userprofile', 'send_mails')
