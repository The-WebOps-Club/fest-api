...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ERPProfile.drive_folders'
        db.add_column(u'users_erpprofile', 'drive_folders',
                      self.gf('django.db.models.fields.TextField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ERPProfile.drive_folders'
        db.delete_column(u'users_erpprofile', 'drive_folders')
    ...
    models = {
        ...
        u'users.erpprofile': {
            ...
            'drive_folders': ('django.db.models.fields.TextField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 13, 0, 0)'}),
