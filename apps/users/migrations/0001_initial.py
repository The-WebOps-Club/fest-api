...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_dept', (
            ...
            ('wall', self.gf('django.db.models.fields.related.OneToOneField')(related_name='dept', unique=True, to=orm['walls.Wall'])),
        ...
        db.create_table(u'users_subdept', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subdepts', to=orm['users.Dept'])),
            ('wall', self.gf('django.db.models.fields.related.OneToOneField')(related_name='subdept', unique=True, to=orm['walls.Wall'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True)),
        ))
        ...
        db.create_table(u'users_userprofile', (
            ...
            ('key_expires', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 29, 0, 0))),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['UserProfile'])

        # Adding model 'ERPProfile'
        db.create_table(u'users_erpprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='erp_profile', unique=True, to=orm['auth.User'])),
            ('wall', self.gf('django.db.models.fields.related.OneToOneField')(related_name='person', unique=True, to=orm['walls.Wall'])),
        ...
        db.send_create_signal(u'users', ['ERPProfile'])

        # Adding M2M table for field coord_relations on 'ERPProfile'
        m2m_table_name = db.shorten_name(u'users_erpprofile_coord_relations')
        ...
        db.create_unique(m2m_table_name, ['erpprofile_id', 'subdept_id'])

        # Adding M2M table for field supercoord_relations on 'ERPProfile'
        m2m_table_name = db.shorten_name(u'users_erpprofile_supercoord_relations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('erpprofile', models.ForeignKey(orm[u'users.erpprofile'], null=False)),
            ('dept', models.ForeignKey(orm[u'users.dept'], null=False))
        ))
        db.create_unique(m2m_table_name, ['erpprofile_id', 'dept_id'])

        # Adding M2M table for field core_relations on 'ERPProfile'
        m2m_table_name = db.shorten_name(u'users_erpprofile_core_relations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('erpprofile', models.ForeignKey(orm[u'users.erpprofile'], null=False)),
            ('dept', models.ForeignKey(orm[u'users.dept'], null=False))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ERPProfile'
        db.delete_table(u'users_erpprofile')

        # Removing M2M table for field coord_relations on 'ERPProfile'
        db.delete_table(db.shorten_name(u'users_erpprofile_coord_relations'))

        # Removing M2M table for field supercoord_relations on 'ERPProfile'
        db.delete_table(db.shorten_name(u'users_erpprofile_supercoord_relations'))

        # Removing M2M table for field core_relations on 'ERPProfile'
        db.delete_table(db.shorten_name(u'users_erpprofile_core_relations'))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 29, 0, 0)'}),
