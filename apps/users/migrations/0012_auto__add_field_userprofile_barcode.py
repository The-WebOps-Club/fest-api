...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.barcode'
        db.add_column(u'users_userprofile', 'barcode',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.barcode'
        db.delete_column(u'users_userprofile', 'barcode')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'barcode': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)'}),
