...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.calendar_id'
        db.add_column(u'users_page', 'calendar_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dept.calendar_id'
        db.add_column(u'users_dept', 'calendar_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.calendar_id'
        db.delete_column(u'users_page', 'calendar_id')

        # Deleting field 'Dept.calendar_id'
        db.delete_column(u'users_dept', 'calendar_id')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 16, 0, 0)'}),
