...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accom.ref_no'
        db.add_column(u'users_accom', 'ref_no',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accom.ref_no'
        db.delete_column(u'users_accom', 'ref_no')
    ...
    models = {
        ...
        u'users.accom': {
            ...
            'ref_no': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 30, 0, 0)'}),
