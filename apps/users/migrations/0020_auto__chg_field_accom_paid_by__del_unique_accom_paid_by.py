...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Accom', fields ['paid_by']
        db.delete_unique(u'users_accom', ['paid_by_id'])


        # Changing field 'Accom.paid_by'
        db.alter_column(u'users_accom', 'paid_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Accom.paid_by'
        db.alter_column(u'users_accom', 'paid_by_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['auth.User']))
        # Adding unique constraint on 'Accom', fields ['paid_by']
        db.create_unique(u'users_accom', ['paid_by_id'])
    ...
    models = {
        ...
        u'users.accom': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paid_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'accom_paid'", 'null': 'True', 'to': u"orm['auth.User']"}),
