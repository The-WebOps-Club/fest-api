...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ERPProfile.summer_stay2'
        db.add_column(u'users_erpprofile', 'summer_stay2',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ERPProfile.winter_stay2'
        db.add_column(u'users_erpprofile', 'winter_stay2',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ERPProfile.summer_stay2'
        db.delete_column(u'users_erpprofile', 'summer_stay2')

        # Deleting field 'ERPProfile.winter_stay2'
        db.delete_column(u'users_erpprofile', 'winter_stay2')
