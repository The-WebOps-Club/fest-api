...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'walls_wall_owners'))

        # Removing M2M table for field visible_to on 'Wall'
        db.delete_table(db.shorten_name(u'walls_wall_visible_to'))

        # Adding M2M table for field notification_subdepts on 'Wall'
        m2m_table_name = db.shorten_name(u'walls_wall_notification_subdepts')
        ...
        # Adding M2M table for field notification_depts on 'Wall'
        m2m_table_name = db.shorten_name(u'walls_wall_notification_depts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wall', models.ForeignKey(orm[u'walls.wall'], null=False)),
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'walls_wall_owners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wall', models.ForeignKey(orm[u'walls.wall'], null=False)),
        ...
        # Removing M2M table for field notification_subdepts on 'Wall'
        db.delete_table(db.shorten_name(u'walls_wall_notification_subdepts'))

        # Removing M2M table for field notification_depts on 'Wall'
        db.delete_table(db.shorten_name(u'walls_wall_notification_depts'))
