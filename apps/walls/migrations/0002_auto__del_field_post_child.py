...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.child'
        db.delete_column(u'walls_post', 'child_id')
    ...
    def backwards(self, orm):
        # Adding field 'Post.child'
        db.add_column(u'walls_post', 'child',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='parent', unique=True, null=True, to=orm['walls.Post'], blank=True),
                      keep_default=False)
