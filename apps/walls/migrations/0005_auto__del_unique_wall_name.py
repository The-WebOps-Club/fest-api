...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Wall', fields ['name']
        db.delete_unique(u'walls_wall', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Wall', fields ['name']
        db.create_unique(u'walls_wall', ['name'])
