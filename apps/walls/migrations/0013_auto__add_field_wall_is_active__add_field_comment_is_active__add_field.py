...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wall.is_active'
        db.add_column(u'walls_wall', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Comment.is_active'
        db.add_column(u'walls_comment', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Post.is_active'
        db.add_column(u'walls_post', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wall.is_active'
        db.delete_column(u'walls_wall', 'is_active')

        # Deleting field 'Comment.is_active'
        db.delete_column(u'walls_comment', 'is_active')

        # Deleting field 'Post.is_active'
        db.delete_column(u'walls_post', 'is_active')
