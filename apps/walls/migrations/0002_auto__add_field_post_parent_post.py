...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'walls_post', 'parent_post',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_posts', null=True, to=orm['walls.Post']),
                      keep_default=False)
    ...
    models = {
        ...
        u'walls.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_post': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_posts'", 'null': 'True', 'to': u"orm['walls.Post']"}),
