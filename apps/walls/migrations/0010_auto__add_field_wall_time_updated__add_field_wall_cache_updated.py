...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Wall.time_updated'
        db.delete_column(u'walls_wall', 'time_updated')

        # Deleting field 'Wall.cache_updated'
        db.delete_column(u'walls_wall', 'cache_updated')

        # Removing M2M table for field notification_pages on 'Wall'
        db.delete_table(db.shorten_name(u'walls_wall_notification_pages'))

        # Removing M2M table for field notification_pages on 'Post'
        db.delete_table(db.shorten_name(u'walls_post_notification_pages'))
