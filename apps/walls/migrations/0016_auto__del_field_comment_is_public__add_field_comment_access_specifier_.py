...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'walls_comment', 'is_public')

        # Adding field 'Comment.access_specifier'
        db.add_column(u'walls_comment', 'access_specifier',
        ...
        # Adding field 'Post.access_specifier'
        db.add_column(u'walls_post', 'access_specifier',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'walls_comment', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Comment.access_specifier'
        db.delete_column(u'walls_comment', 'access_specifier')
        ...
        # Deleting field 'Post.access_specifier'
        db.delete_column(u'walls_post', 'access_specifier')
    ...
    models = {
        ...
        u'walls.comment': {
            ...
            'access_specifier': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
