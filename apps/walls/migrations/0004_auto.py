...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field notification_depts on 'Post'
        m2m_table_name = db.shorten_name(u'walls_post_notification_depts')
        ...
        # Adding M2M table for field notification_subdepts on 'Post'
        m2m_table_name = db.shorten_name(u'walls_post_notification_subdepts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm[u'walls.post'], null=False)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field notification_depts on 'Post'
        db.delete_table(db.shorten_name(u'walls_post_notification_depts'))

        # Removing M2M table for field notification_subdepts on 'Post'
        db.delete_table(db.shorten_name(u'walls_post_notification_subdepts'))
