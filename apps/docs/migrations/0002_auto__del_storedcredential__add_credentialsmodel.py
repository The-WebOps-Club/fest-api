...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'docs_credentialsmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
            ('credential', self.gf('apps.docs.oauth2client.django_orm.CredentialsField')(null=True)),
        ))
        db.send_create_signal(u'docs', ['CredentialsModel'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'docs_credentialsmodel')
    ...
    models = {
        ...
        u'docs.credentialsmodel': {
            'Meta': {'object_name': 'CredentialsModel'},
            'credential': ('apps.docs.oauth2client.django_orm.CredentialsField', [], {'null': 'True'}),
