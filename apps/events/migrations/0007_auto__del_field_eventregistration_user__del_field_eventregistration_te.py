...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_eventregistration', 'teams_registered',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_team', null=True, to=orm['users.Team']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'events_eventregistration', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_events', null=True, to=orm['users.Team'], blank=True),
                      keep_default=False)
