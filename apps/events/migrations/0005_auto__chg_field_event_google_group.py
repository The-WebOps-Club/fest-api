...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.google_group'
        db.alter_column(u'events_event', 'google_group', self.gf('django.db.models.fields.EmailField')(max_length=99, null=True))

    def backwards(self, orm):

        # Changing field 'Event.google_group'
        db.alter_column(u'events_event', 'google_group', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'google_group': ('django.db.models.fields.EmailField', [], {'max_length': '99', 'null': 'True', 'blank': 'True'}),
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 19, 0, 0)'}),
