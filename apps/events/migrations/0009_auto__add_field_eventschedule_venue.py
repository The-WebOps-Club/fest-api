...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventSchedule.venue'
        db.add_column(u'events_eventschedule', 'venue',
                      self.gf('django.db.models.fields.CharField')(default='Aerofest', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventSchedule.venue'
        db.delete_column(u'events_eventschedule', 'venue')
