...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventParticipation.event_for_participation'
        db.alter_column(u'events_eventparticipation', 'event_for_participation_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['events.Event']))
        # Adding unique constraint on 'EventParticipation', fields ['event_for_participation']
        db.create_unique(u'events_eventparticipation', ['event_for_participation_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventParticipation', fields ['event_for_participation']
        db.delete_unique(u'events_eventparticipation', ['event_for_participation_id'])


        # Changing field 'EventParticipation.event_for_participation'
        db.alter_column(u'events_eventparticipation', 'event_for_participation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event']))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 5, 0, 0)'}),
