...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WebsiteUpdate'
        db.create_table(u'events_websiteupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal(u'events', ['WebsiteUpdate'])


    def backwards(self, orm):
        # Deleting model 'WebsiteUpdate'
        db.delete_table(u'events_websiteupdate')
