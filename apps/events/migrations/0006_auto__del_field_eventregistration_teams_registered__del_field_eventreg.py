...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventRegistration.teams_registered'
        db.delete_column(u'events_eventregistration', 'teams_registered_id')

        # Deleting field 'EventRegistration.users_registered'
        db.delete_column(u'events_eventregistration', 'users_registered_id')

        # Adding field 'EventRegistration.user'
        db.add_column(u'events_eventregistration', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='event_registrations', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EventRegistration.team'
        db.add_column(u'events_eventregistration', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='related_events', null=True, to=orm['users.Team']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventRegistration.teams_registered'
        db.add_column(u'events_eventregistration', 'teams_registered',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_team', null=True, to=orm['users.Team'], blank=True),
                      keep_default=False)

        # Adding field 'EventRegistration.users_registered'
        db.add_column(u'events_eventregistration', 'users_registered',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user_eventregis', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'EventRegistration.user'
        db.delete_column(u'events_eventregistration', 'user_id')

        # Deleting field 'EventRegistration.team'
        db.delete_column(u'events_eventregistration', 'team_id')
    ...
    models = {
        ...
        u'events.eventregistration': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'registraions'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_events'", 'null': 'True', 'to': u"orm['users.Team']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_registrations'", 'to': u"orm['auth.User']"})
        },
        u'events.eventtab': {
