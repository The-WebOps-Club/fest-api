...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventFeedback'
        db.create_table(u'events_eventfeedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q1', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('q2', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('q3', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('q4', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('q5', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('event', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'events', ['EventFeedback'])


    def backwards(self, orm):
        # Deleting model 'EventFeedback'
        db.delete_table(u'events_eventfeedback')
    ...
    models = {
        ...
        u'events.eventfeedback': {
            'Meta': {'object_name': 'EventFeedback'},
            'event': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'q1': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'q2': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'q3': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'q4': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'q5': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
        u'events.eventparticipation': {
            'Meta': {'object_name': 'EventParticipation'},
            'event_for_participation': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'event_participated'", 'unique': 'True', 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 8, 0, 0)'}),
