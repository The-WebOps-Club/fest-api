...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PushNotification.status'
        db.add_column(u'api_pushnotification', 'status',
                      self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PushNotification.status'
        db.delete_column(u'api_pushnotification', 'status')
