...
function setup_autocomplete_lists() {
    ...
    emoji_config = {
      at: ":",
      data: $.map(emojis, function(value, i) {return {name:value}}),
      tpl:"<li data-value=':${name}:'><img src='https://assets.github.com/images/icons/emoji/${name}.png'  height='16' width='16' /> &nbsp; ${name} </li>",
      insert_tpl: "<img src='https://assets.github.com/images/icons/emoji/${name}.png'  height='16' width='16' />",
    }

    $(".atwho_at_config").atwho(at_config).atwho(emoji_config);
