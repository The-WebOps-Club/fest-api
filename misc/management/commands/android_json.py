...
class Command(BaseCommand):
    ...
    def handle(self, arg=None, **options):
        ...
        saarang = {
            ...
            "startTimestamp": "2016-01-07T09:00:01Z",
            "endTimestamp": "2016-01-07T16:00:00Z",
            "title": "Saarang 2016",
        ...
        rockshow = {
            "speakers": [],
            "description":"<p><a href='http://saarang.org/tickets'><b>TICKETS AT BOOKMYSHOW - SAARANG</b></a></p><p>IIT Madras is proud to announce Karnivool as the headlining act for the Rock Show at Saarang 2016. Karnivool will be performing live for the first time in Chennai, at the IIT Madras Open Air Theatre on January 10th, 2016.</p><p>Karnivool is an Australian progressive rock band from Perth, Australia, critically hailed as being one of the bands that established the Australian progressive rock and metal movement. They are considered to be amongst the few in Australia's rapidly growing music industry to still be bringing new and refreshing material to their catalogue. The five-member band consists of Ian Kenny on vocals, Drew Goddard and Mark Hosking on guitar, Jon Stockman on bass, and Steve Judd on drums.</p>",
        ...
        popular = {
            ...
            "startTimestamp": "2016-01-11T12:30:00Z",
            "endTimestamp": "2016-01-11T16:30:00Z",
