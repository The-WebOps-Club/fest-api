...
class Command(BaseCommand):
	...
	def handle(self, arg1=None, arg2=None, **options):
		
		if arg1 == "college":
			"""
				Arg1 = "college"
				Arg2 = path of file to import colleges from
			"""
			if not arg2: arg2 = "files/data/colleges_2014.csv"
			arg_path = os.path.abspath(os.path.join(settings.PROJECT_PATH, arg2))
